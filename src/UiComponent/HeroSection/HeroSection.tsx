...
const HeroSection: React.FC = () => {
  return (
    <div className={styles.container}>
      <Image src="/scale.svg" className={styles.imgBox} width={500} height={500} priority={true} alt="Home Logo" />
      ...
      <button className={styles.button}>
        <h2 className="">
          Referral Program</h2><p className="">Earn credits by sharing with friends, relatives, and
          people you know
        </p>
      </button>
    </div>
